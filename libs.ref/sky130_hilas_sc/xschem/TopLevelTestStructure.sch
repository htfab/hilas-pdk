...
N -1170 -340 -1170 510 { lab=GateAndCap1}
N -1170 -280 -1130 -280 { lab=GateAndCap1}
N -1170 -260 -1130 -260 { lab=GateAndCap1}
N -1170 -240 -1130 -240 { lab=GateAndCap1}
N -1170 -220 -1130 -220 { lab=GateAndCap1}
N -1170 -200 -1130 -200 { lab=GateAndCap1}
N -1170 -180 -1130 -180 { lab=GateAndCap1}
N -1170 70 -1130 70 { lab=GateAndCap1}
N -1170 90 -1130 90 { lab=GateAndCap1}
N -1170 110 -1130 110 { lab=GateAndCap1}
N -1170 130 -1130 130 { lab=GateAndCap1}
N -1170 330 -1130 330 { lab=GateAndCap1}
N -1170 440 -1130 440 { lab=GateAndCap1}
N -790 -310 -790 510 { lab=Well}
N -750 -310 -750 510 { lab=SourceP}
N -710 -310 -710 500 { lab=SourceN}
N -830 -240 -790 -240 { lab=Well}
N -830 110 -790 110 { lab=Well}
N -830 460 -790 460 { lab=Well}
N -830 -220 -750 -220 { lab=SourceP}
N -830 -200 -710 -200 { lab=SourceN}
N -830 -140 -750 -140 { lab=SourceP}
N -830 -120 -710 -120 { lab=SourceN}
N -830 -60 -750 -60 { lab=SourceP}
N -830 -40 -710 -40 { lab=SourceN}
N -830 130 -750 130 { lab=SourceP}
N -830 150 -710 150 { lab=SourceN}
N -830 230 -750 230 { lab=SourceP}
N -830 210 -710 210 { lab=SourceN}
N -830 350 -710 350 { lab=SourceN}
N -830 480 -750 480 { lab=SourceP}
...
N -1170 690 -540 690 { lab=GateAndCap1}
N -1170 510 -1170 690 { lab=GateAndCap1}
N -830 -280 -670 -280 { lab=Drain1p}
N -830 -260 -670 -260 { lab=Drain1n}
N -830 -180 -670 -180 { lab=Drain2p}
N -830 -160 -670 -160 { lab=Drain2n}
N -830 -100 -670 -100 { lab=Drain3p}
N -830 -80 -670 -80 { lab=Drain3n}
N -830 70 -670 70 { lab=Drain4p}
N -830 90 -670 90 { lab=Drain4n}
N -830 170 -670 170 { lab=Drain5p}
N -830 190 -670 190 { lab=Drain5n}
N -830 330 -670 330 { lab=Drain6n}
N -830 440 -670 440 { lab=Drain6p}
N -710 -330 -710 -310 { lab=SourceN}
N -750 -360 -750 -310 { lab=SourceP}
N -790 -400 -790 -310 { lab=Well}
...
C {swc4x2.sym} 180 100 0 0 {name=x1}
C {drainSelect01.sym} -320 100 0 0 {name=x2}
C {WTA4input.sym} 180 320 0 0 {name=x3}
C {TA2Cell_1FG_Strong.sym} 180 -470 0 0 {name=x4}
C {TA2Cell_1FG.sym} 180 -170 0 0 {name=x6}
C {Tgate4Single01.sym} 770 -320 0 1 {name=x7}
C {Trans2med.sym} -980 150 0 0 {name=x8}
C {Trans4small.sym} -980 -160 0 0 {name=x9}
C {nFETLarge.sym} -980 340 0 0 {name=x10}
C {pFETLarge.sym} -980 460 0 0 {name=x11}
C {FGcharacterization01.sym} 180 630 0 0 {name=x12}
C {DAC5bit01.sym} 1000 740 0 0 {name=x14}
C {drainSelect01.sym} -320 300 0 0 {name=x16}
C {devices/gnd.sym} 330 500 0 0 {name=l1 lab=GND}
C {nFETLarge.sym} 180 470 0 0 {name=x17}
C {drainSelect01.sym} -320 -310 0 0 {name=x18}
...
C {devices/iopin.sym} -670 -280 0 0 {name=Drain1p lab=Drain1p}
C {devices/iopin.sym} -670 -260 0 0 {name=Drain1n lab=Drain1n}
C {devices/iopin.sym} -670 -180 0 0 {name=Drain2p lab=Drain2p}
C {devices/iopin.sym} -670 -160 0 0 {name=Drain2n lab=Drain2n}
C {devices/iopin.sym} -670 -100 0 0 {name=Drain3p lab=Drain3p}
C {devices/iopin.sym} -670 -80 0 0 {name=Drain3n lab=Drain3n}
C {devices/iopin.sym} -670 70 0 0 {name=Drain4p lab=Drain4p}
C {devices/iopin.sym} -670 90 0 0 {name=Drain4n lab=Drain4n}
C {devices/iopin.sym} -670 170 0 0 {name=Drain5p lab=Drain5p}
C {devices/iopin.sym} -670 190 0 0 {name=Drain5n lab=Drain5n}
C {devices/iopin.sym} -670 440 0 0 {name=Drain6p lab=Drain6p}
C {devices/iopin.sym} -670 330 0 0 {name=Drain16n lab=Drain6n}
C {devices/iopin.sym} -710 -330 0 0 {name=SourceN lab=SourceN}
C {devices/iopin.sym} -750 -360 0 0 {name=SourceP lab=SourceP}
C {devices/iopin.sym} -790 -400 0 0 {name=Well lab=Well}
